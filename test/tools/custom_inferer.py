...
class Inferer:
    ...
    def infer(self, conf_thres=0.4, iou_thres=0.45, classes=None, agnostic_nms=False,
        ...
        for img_src, img_path, vid_cap, depth_img in tqdm(self.files):
            ...
            if view_img:
                ...
                if cv2.waitKey(1) == 27:  # Check if ESC key is pressed
    ...
    @staticmethod
    def plot_box_and_label(image, lw, box, depth, label='', color=(128, 128, 128), txt_color=(255, 255, 255), font=cv2.FONT_HERSHEY_COMPLEX):
        ...
        if label:
            ...
            if depth is not None:
                cv2.putText(image, "{} cm".format(depth / 10), (p1[0] + 5, p1[1] + 60), 0, 1.0, (255, 255, 255), 2)
